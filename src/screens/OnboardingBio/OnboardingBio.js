...
import { Paragraph, InputField, ErrorAlert } from '../../components';
        ...
        <KeyboardAvoidingView style={styles.wrapper} behavior='padding'>
          <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formContainer}>
              <Paragraph text={'Gender *'} styles={styles.formHeaderTxt} />
              <TouchableOpacity
                    ...
                    <View style={{ flex: 1, justifyContent: 'center' }}>
                      ...
                      {pickerGender.map((value, index) => {
                        return (
                          <TouchableHighlight
                            key={index}
                            onPress={() => this.setGenderPicker(value.value)}
                          >
            ...
            <View style={styles.CountryView}>
              <Paragraph text={'Nationality'} styles={styles.formHeaderTxt} />
              <TouchableOpacity
                underlayColor={colors.white}
                ...
                <View style={{ flex: 1, paddingLeft: 20, paddingRight: 20 }}>
                  <View style={{ flex: 7, marginTop: 10 }}>
                    ...
                    <FlatList
                      ...
                      renderItem={({ item }) => (
                        <TouchableWithoutFeedback
                          onPress={() => this.selectNationality(item.name)}
                        >
            ...
            <View
              style={[
                ...
                {
                  borderBottomColor: isCompanyFocused
                    ? colors.green
            ...
            <View
              style={[
                styles.nameInputView,
                {
                  borderBottomColor: isShortBioFocused
                    ? colors.green
                    : theme.secondaryTextColor,
                },
              ]}
            >
              ...
              <View style={{ flexDirection: 'row', width: '90%' }}>
                <TextInput
                  placeholder={
                    'Example: A decade of experience in photography jounalism. Love creating pieces that captivate and move to action'
                  }
                  numberOfLines={5}
                  multiline={true}
