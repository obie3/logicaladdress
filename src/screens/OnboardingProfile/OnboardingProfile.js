...
import { Paragraph, InputField, ErrorAlert, Preloader } from '../../components';
...
class OnboardingProfile extends Component {
  ...
  uploadImageAsync = async pickerResult => {
    ...
    await sendRoute(ImageUploadEndpoint, data).then(res => {
  ...
  handleUpdateImageUri = async photo => {
    ...
    // console.log({data})
    await putRoute(ProfileUpdateEndpoint, data, token).then(res => {
            ...
            <View style={styles.viewBody}>
              ...
              <View style={styles.titleView}>
                <View style={styles.formContainer}>
                  <Paragraph text={'Title *'} styles={styles.formHeaderTxt} />
                  <TouchableOpacity
                  ...
                  >
                    <View style={styles.viewTxtTitle}>
                      <Text style={styles.titleText}>{name_title}</Text>
                      <Image
                        ...
                        <View style={{ flex: 1, justifyContent: 'center' }}>
                          ...
                          {pickerTitle.map((value, index) => {
                            return (
                              <TouchableHighlight
                                key={index}
                                onPress={() => this.setTitlePicker(value.value)}
                              >
              ...
              <View
                style={[
                  styles.titleInputView,
                  {
                    borderBottomColor: isJobTitleFocused
                      ? colors.green
                      : theme.secondaryTextColor,
                  },
                ]}
