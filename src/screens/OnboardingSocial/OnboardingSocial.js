...
class OnboardingSocial extends Component {
  ...
  componentWillMount() {
    ...
    const defaultFlag = data.filter(obj =>
      obj.name === profile.country ? profile.country : 'Afghanistan',
    )[0].flag;
    this.setState({
      flag: defaultFlag,
    });
  ...
  handleSubmitButton = async () => {
    ...
    await putRoute(ProfileUpdateEndpoint, body, token).then(res => {
      // console.log({res})
      this.setState({
        showLoading: false,
      });
        ...
        <KeyboardAvoidingView style={styles.wrapper} behavior='padding'>
          <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formView}>
              <Paragraph text={'Phone Number'} styles={styles.formHeaderTxt} />
              <View
                style={[
                  styles.phoneView,
                  {
                    borderBottomColor: isPhoneFocused
                      ? colors.green
            ...
            <View
              style={[
                ...
                {
                  borderBottomColor: isWebsiteFocused
                    ? colors.green
                    : theme.secondaryTextColor,
                },
              ]}
                ...
                <View style={styles.socialView}>
                  <View
                    style={[
                      ...
                      {
                        borderBottomColor: isFacebookFocused
                          ? colors.green
                          : theme.secondaryTextColor,
                      },
                    ]}
                  >
                    <View style={{ flexDirection: 'row', width: '75%' }}>
                      ...
                      <InputField
                        ...
                        blurOnSubmit={false}
                        refs={input => {
                          this.facebookRef = input;
                        }}
                        onFocus={() =>
                          this.setState({ isFacebookFocused: true })
                        }
                        onBlur={() =>
                          this.setState({ isFacebookFocused: false })
                        }
                        onSubmitEditing={() => {
                ...
                <View style={styles.socialView}>
                  <View
                    style={[
                      styles.textInputView,
                      {
                        borderBottomColor: isTwitterFocused
                          ? colors.green
                          : theme.secondaryTextColor,
                      },
                    ]}
                  >
                    <View style={{ flexDirection: 'row', width: '75%' }}>
                      ...
                      <InputField
                        ...
                        blurOnSubmit={false}
                        refs={input => {
                          this.twitterRef = input;
                        }}
                        onFocus={() =>
                          this.setState({ isTwitterFocused: true })
                        }
                        onBlur={() =>
                          this.setState({ isTwitterFocused: false })
                        }
                        onSubmitEditing={() => {
                ...
                <View style={styles.socialView}>
                  <View
                    style={[
                      styles.textInputView,
                      {
                        borderBottomColor: isLinkedInFocused
                          ? colors.green
                          : theme.secondaryTextColor,
                      },
                    ]}
                  >
                    <View style={{ flexDirection: 'row', width: '75%' }}>
                      ...
                      <InputField
                        ...
                        blurOnSubmit={false}
                        refs={input => {
                          this.linkedInRef = input;
                        }}
                        onFocus={() =>
                          this.setState({ isLinkedInFocused: true })
                        }
                        onBlur={() =>
                          this.setState({ isLinkedInFocused: false })
                        }
                        onSubmitEditing={() => {
                ...
                <View style={styles.socialView}>
                  <View
                    style={[
                      styles.textInputView,
                      {
                        borderBottomColor: isInstagramFocused
                          ? colors.green
                          : theme.secondaryTextColor,
                      },
                    ]}
                  >
                    <View style={{ flexDirection: 'row', width: '75%' }}>
                      ...
                      <InputField
                        ...
                        blurOnSubmit={false}
                        refs={input => {
                          this.instagramRef = input;
                        }}
                        onFocus={() =>
                          this.setState({ isInstagramFocused: true })
                        }
                        onBlur={() =>
                          this.setState({ isInstagramFocused: false })
                        }
                        onSubmitEditing={() => {
